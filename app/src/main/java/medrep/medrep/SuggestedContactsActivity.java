...
/**
 * Created by GunaSekhar on 27-06-2016.
 */
public class SuggestedContactsActivity extends AppCompatActivity implements View.OnClickListener, GetResponse {
...
//        searchConnections.setAdapter(adapter);
    ...
    protected void onStart() {
        ...
        String url = HttpUrl.COMMONURL + "/getSuggestedContacts?token=" + accessToken;
    ...
    private void initializeGridView(final JSONArray result) {
        ...
        contactsGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(SuggestedContactsActivity.this, DoctorPostsActivity.class);
                JSONObject object = null;
                try {
                    object = resultArray.getJSONObject(position);
                    String firstName = object.getString("firstName");
                    String lastName = object.getString("lastName");
                    String fullName = firstName + " " + lastName;
                    ...
                    int contactId = 0;
                    if(!object.isNull("contactId")) {
                        contactId = object.getInt("contactId");
                    }
...
//                cancelButton.setOnClickListener(SuggestedContactsActivity.this);
//                Button addMembers = (Button)dialogView.findViewById(R.id.addMembersButton);
//                addMembers.setOnClickListener(SuggestedContactsActivity.this);
//                Button pendingMembersButton = (Button)dialogView.findViewById(R.id.pendingMembersButton);
//                pendingMembersButton.setOnClickListener(SuggestedContactsActivity.this);
...
//
            ...
            case R.id.searchButton:
                ...
                if (searchText.length() >= 2) {
                    //accessToken = SignIn.GET_ACCESS_TOKEN();
                    url = HttpUrl.COMMONURL + "/getDoctorContacts/" + searchText + "?token=" + accessToken;
                    NotificationGetTask getData = new NotificationGetTask();
                    getData.delegate = SuggestedContactsActivity.this;
                    getData.execute(url);
                }
                break;
        }
